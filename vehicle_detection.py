...
# Conv Layer 1
model.add(Convolution2D(60, 3, 3, border_mode='valid', subsample=(1,1), activation = 'relu', name = 'Conv1', input_shape=input_shape))
...
model.fit_generator(generator(x_train_data, y_train_data, batch_size=batch_size), samples_per_epoch = len(x_train_data),
