...
cars0 = glob.glob('E:/database/car/vehicles/GTI_Far/*.png')
cars1 = glob.glob('E:/database/car/vehicles/GTI_MiddleClose/*.png')
cars2 = glob.glob('E:/database/car/vehicles/GTI_Left/*.png')
cars3 = glob.glob('E:/database/car/vehicles/GTI_Right/*.png')
cars4 = glob.glob('E:/database/car/vehicles/KITTI_extracted/*.png')
#cars4 += glob.glob('./vehicles/augmentation/*.png')
notcars1 = glob.glob('E:/database/car/non-vehicles/Extras/*.png')
notcars1 += glob.glob('E:/database/car/non-vehicles/GTI/*.png')
